...
CREATE TABLE `car` (
  ...
  `carcard` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
...
INSERT INTO `car` VALUES ('b728bfecc6de46f38b083f9ede6baf68', 'a41ea838980d40a28a90882d8af09731', '1', '1', '1');
...
-- ----------------------------
INSERT INTO `emailactive` VALUES ('386c75c99aad4faf9158b6eda2fbf37e', 'a41ea838980d40a28a90882d8af09731');
...
CREATE TABLE `parking` (
  ...
  `inspaceid` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '进入地点id',
  `nowspaceid` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '现在所在地点id',
  `savespaceid` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '存储地点id',
  `outspaceid` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '离开地点id',
  `vipsendtime` datetime(6) DEFAULT NULL COMMENT '预约时间时',
  `vipappparkingtime` datetime(6) DEFAULT NULL COMMENT '预约停车时间',
  `inplacetime` datetime(6) DEFAULT NULL COMMENT '进入车库时间',
  `intime` datetime(6) DEFAULT NULL COMMENT '存车时间',
  `vipgettime` datetime(6) DEFAULT NULL COMMENT '预约取车时时间',
  `vipappgettime` datetime(6) DEFAULT NULL COMMENT '预约取车时间',
  `outtime` datetime(6) DEFAULT NULL COMMENT '取车时间',
  `outplacetime` datetime(6) DEFAULT NULL COMMENT '离开车库时间',
  `gettime` datetime(6) DEFAULT NULL COMMENT '获得车辆时间',
  `nature` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '性质',
  `way` text CHARACTER SET utf8 COLLATE utf8_general_ci,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;
...
CREATE TABLE `user` (
  ...
  `phonenature` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `email` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `emailnature` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES ('a41ea838980d40a28a90882d8af09731', '新用户1', '1', '1', '1', '1', '1', '1', '1', '2');
...
-- Records of vip
-- ----------------------------
INSERT INTO `vip` VALUES ('d03ad4b0d1514345923dc9e6c6cd2a6e', 'a41ea838980d40a28a90882d8af09731', '2019-05-09 16:08:06.294000');
