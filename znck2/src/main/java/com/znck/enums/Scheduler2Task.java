...
//        getCar();
	...
	public void carNextWayWhenSave(SpaceEntity nowSpace, SpaceEntity fetureSpace, ParkingEntity parking)
			throws ParseException {
	...
	public void carNextWayWhenGet(SpaceEntity nowSpace, SpaceEntity fetureSpace, ParkingEntity parking)
			throws ParseException {
		final String x = "x";
		final String y = "y";
		final String z = "z";
		...
		zb = this.getNextSpaceWhenTakingOutCar(nowSpace.getX(), nowSpace.getY(), nowSpace.getZ(), fetureSpace.getX(),
				fetureSpace.getY(), fetureSpace.getZ());
		SpaceEntity nextSpace = spaceService.getSpaceByXYZ(zb.get(x), zb.get(y), zb.get(z));
