...
CREATE TABLE `car`  (
  ...
  `carcard` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `carname` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `carinfo` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
...
-- Records of car
-- ----------------------------
INSERT INTO `car` VALUES ('38ed38d9d3744486830a7c7d3366cac5', '51754bed755e44dbadd83bd3d0c14560', '1', '1', '1');
INSERT INTO `car` VALUES ('905cc5e8a65545d1b635b80062d735c1', '51754bed755e44dbadd83bd3d0c14560', '3', '3', '3');
...
-- ----------------------------
INSERT INTO `emailactive` VALUES ('dd87400b10814593ad7857808b4d5736', '51754bed755e44dbadd83bd3d0c14560');
...
CREATE TABLE `parking`  (
  `id` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `carid` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `nowspaceid` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `feturespaceid` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `intime` datetime(6) NULL DEFAULT NULL,
  `outtime` datetime(6) NULL DEFAULT NULL,
  `nature` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '性质：存车中，停车中，取车中',
  `way` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for parking2
-- ----------------------------
DROP TABLE IF EXISTS `parking2`;
CREATE TABLE `parking2`  (
  `id` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `carid` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `inspaceid` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '进入地点id',
  `nowspaceid` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '现在所在地点id',
  `savespaceid` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '存储地点id',
  `outspaceid` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '离开地点id',
  `vipsendtime` datetime(6) NULL DEFAULT NULL COMMENT '预约时间时',
  `vipappparkingtime` datetime(6) NULL DEFAULT NULL COMMENT '预约停车时间',
  `inplacetime` datetime(6) NULL DEFAULT NULL COMMENT '进入车库时间',
  `intime` datetime(6) NULL DEFAULT NULL COMMENT '存车时间',
  `vipgettime` datetime(6) NULL DEFAULT NULL COMMENT '预约取车时时间',
  `vipappgettime` datetime(6) NULL DEFAULT NULL COMMENT '预约取车时间',
  `outtime` datetime(6) NULL DEFAULT NULL COMMENT '取车时间',
  `outplacetime` datetime(6) NULL DEFAULT NULL COMMENT '离开车库时间',
  `gettime` datetime(6) NULL DEFAULT NULL COMMENT '获得车辆时间',
...
CREATE TABLE `parkingsave`  (
  ...
  `carid` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '汽车id',
  `way` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '经过的路径',
  `intime` datetime(6) NULL DEFAULT NULL COMMENT '存车时间',
  `saveinplacetime` datetime(6) NULL DEFAULT NULL COMMENT '存入时间',
  `outtime` datetime(6) NULL DEFAULT NULL COMMENT '取车时间',
  `outinplacetime` datetime(6) NULL DEFAULT NULL COMMENT '取走时间',
  `savespaceid` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '存车地点id',
  `nature` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '是否预约停车',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `space`  (
  ...
  `nature` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '性质：空车位？',
  `carid` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `user`  (
  ...
  `phonenature` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `email` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `emailnature` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES ('51754bed755e44dbadd83bd3d0c14560', '新用户15703286077', '123456', 's', 's', '15703286077', '1', 's', '1', '1');
